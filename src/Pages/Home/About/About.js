        ...
        <Row style={{  backgroundColor: "#282932"}}>
            ...
            <Col lg={6} className="">
                ...
                <article style={{padding:"70px"}}>
                     ...
                     <p style={{fontSize:"17px",fontWeight:"500",lineHeight:"1.7em",color:"whitesmoke"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio molestias, facilis asperiores, aperiam ipsum perferendis accusantium praesentium officia vero dolorem adipisci doloremque .</p>
